...
<html lang="en" class="light-style layout-wide  customizer-hide" dir="ltr" data-theme="light"
  data-assets-path="{{ asset('admin-assets') }}/assets/" data-template="vertical-menu-template">


<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 10:07:40 GMT -->
...
<head>
  ...
  <title>Login Admin JobKeepSir</title>
  ...
  <!-- Vendor -->
  <link rel="stylesheet"
    href="{{ asset('admin-assets') }}/assets/vendor/libs/%40form-validation/umd/styles/index.min.css" />
...
<body>
      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2">JobKeepSir Admin</h4>
            <p class="mb-4">Please sign-in to admin account</p>
            @if (Session::has('error'))
              <div class="alert alert-danger" role="alert">
                Wrong Email or Password !
              </div>
            @endif
            <form id="formAuthentication" class="mb-3" action="{{ route('admin.proseslogin') }}" method="POST">
              @csrf
              <div class="mb-3">
              ...
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" class="form-control" name="password" id="basic-default-password32"
  ...
  <!-- Vendors JS -->
  <script src="{{ asset('admin-assets') }}/assets/vendor/libs/%40form-validation/umd/bundle/popular.min.js"></script>
  <script src="{{ asset('admin-assets') }}/assets/vendor/libs/%40form-validation/umd/plugin-bootstrap5/index.min.js">
  </script>
  <script src="{{ asset('admin-assets') }}/assets/vendor/libs/%40form-validation/umd/plugin-auto-focus/index.min.js">
  </script>
  ...
  <!-- Page JS -->
  <script src="{{ asset('admin-assets') }}/assets/js/pages-auth.js"></script>

</body>


<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 10:07:41 GMT -->
